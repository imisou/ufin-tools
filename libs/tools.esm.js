...
* Copyright 2021-2024 jed. All Rights Reserved
...
var JsCookies = /*@__PURE__*/getDefaultExportFromCjs(js_cookieExports);
...
var setCookie = function setCookie() {
  ...
  var currentCookieSetting = _objectSpread2(_objectSpread2({}, DEFAULT_COOKIE_OPTIONS), {}, {
    expires: 1
  });
  _extends(currentCookieSetting, cookieSetting || {});
  JsCookies.set("".concat(DEFAULT_COOKIE_OPTIONS.prefix, "-").concat(name), value, currentCookieSetting);
};
/**
...
var getCookieByName = function getCookieByName() {
  var name = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'default';
  return JsCookies.get("".concat(DEFAULT_COOKIE_OPTIONS.prefix, "-").concat(name));
};
/**
...
var removeCookie = function removeCookie() {
  ...
  JsCookies.remove("".concat(DEFAULT_COOKIE_OPTIONS.prefix, "-").concat(name), {
    path: path
  });
};
...
export { BrowserDetectOS, BrowserType, EmailRegexp, IPRegexp, addClass, dateUtil, formatChinese, formateTime, getBrowser, getCookieAll, getCookieByName, getOs, getStyle, getUUID, getUrlQuery, getUrlQueryByName, hasClass, initCookie, isArray, isBoolean, isCardID, isEmail, isEmptyValue, isEnglishName, isFunction, isIP, isIos, isNil, isNull, isNumber, isObject, isPC, isString, isSymbol, isUndefined, noop, random, relativeTime, removeClass, removeCookie, setCookie, setDocumentTitle, setStyle, setTitle, url };
